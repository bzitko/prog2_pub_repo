"""
💻 grupa
za zadanu listu riječi stvori rječnik u kojemu je 
ključ duljina riječi,
a vrijednost lista svih riječi te duljine
"""    
def grupa(lista):
    rjecnik = {}
    for rijec in lista:
...
if __name__ == '__main__':
    title(grupa)
    test(grupa, ["pas", "mačka", "lav", "ptica"], {3: ['pas', 'lav'], 5: ['mačka', 'ptica']})
